...
namespace Microcharts.Samples.Forms
{
    public partial class MainPage : Xamarin.Forms.ContentPage
    {
        ...
        {
            var values = Enumerable.Range(0, 12).Select(x => random.Next(8000, 17000)).ToArray();
            return new ChartEntry[]
            {
                ...
                //new ChartEntry(values[0]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[1]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[2]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[3]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[4]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[5]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[6]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[7]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[8]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[9]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[10]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[11]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[0]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[1]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[2]) { Color = SKColor.Parse("#FF0000") },
                //new ChartEntry(values[3]) { Color = SKColor.Parse("#FF0000") },
        ...
        private void GenerateData(object sender, EventArgs e)
        {
            if (this.chart.Chart != null)
            {
                ...
                {
                    lineChart.PointMode = PointMode.None;
                    lineChart.FillAndExpandedChart = true;
                    lineChart.EnableYSolidGradient = true;
                    lineChart.GradientYColorStart = SKColors.White;
                    lineChart.GradientYColorEnd = SKColor.Parse("#deb4ca");
                }
            }
        }
